...
record = wfdb.rdrecord("ptb-xl-a-large-publicly-available-electrocardiography-dataset-1.0.1/records100/00000/00017_lr", channels=[0])
...
for segment in features.get("heartbeat_segments", []):
    ...
    print("Pred:", ALL_CLASSES[pred], "Category:", scp_df.loc[ALL_CLASSES[pred]]['diagnostic_class'] if ALL_CLASSES[pred] in PTBXL_CLASSES else "MIT")
